...
<body class="product color">
	...
	<main id="content" class="common-list colorful-list">
        ...
        <nav class="product-nav">
            <div class="container">
                <ul>
                    <li><a href="/mobile/color/beige_list.php">BEIGE</a></li>
                    ...
                    <li class="active"><a href="/mobile/color/colorful_list.php">COLORFUL</a></li>
                </ul>
            </div>
        </nav>
        ...
        <article>
            <div class="article-header">
                <div class="container">
                    <h3 class="article-title">COLORFUL</h3>
                    <p class="summary">
