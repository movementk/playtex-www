...
<body class="product design">
	...
	<main id="content" class="common-list under-list">
        ...
        <nav class="product-nav">
            <div class="container">
                <ul>
                    ...
                    <li class="active space"><a href="/mobile/design/under_cover_list.php">UNDER<br>COVER</a></li>
        ...
        <article>
            <div class="article-header">
                <div class="container">
                    <h3 class="article-title">UNDER COVER</h3>
                    <p class="summary">
