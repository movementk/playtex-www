...
<body class="product design">
	...
	<main id="content" class="common-list ideal-list">
        ...
        <nav class="product-nav">
            <div class="container">
                <ul>
                    ...
                    <li class="active space"><a href="/mobile/design/ideal_beauty_list.php">IDEAL<br>BEAUTY</a></li>
        ...
        <article>
            <div class="article-header">
                <div class="container">
                    <h3 class="article-title">IDEAL BEAUTY</h3>
                    <p class="summary">
