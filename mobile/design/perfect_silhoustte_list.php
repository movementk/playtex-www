...
<body class="product design">
	...
	<main id="content" class="common-list perfect-list">
        ...
        <nav class="product-nav">
            <div class="container">
                <ul>
                    ...
                    <li class="active space"><a href="/mobile/design/perfect_silhoustte_list.php">PERFECT<br>SILHOUETTE</a></li>
                </ul>
            </div>
        </nav>
        ...
        <article>
            <div class="article-header">
                <div class="container">
                    <h3 class="article-title">PERFECT SILHOUETTE</h3>
                    <p class="summary">
