...
<body class="product design">
	...
	<main id="content" class="common-list essential-list">
        ...
        <nav class="product-nav">
            <div class="container">
                <ul>
                    ...
                    <li class="active"><a href="/mobile/design/essential_list.php">ESSENTIAL</a></li>
        ...
        <article>
            <div class="article-header">
                <div class="container">
                    <h3 class="article-title">ESSENTIAL</h3>
                    <p class="summary">
